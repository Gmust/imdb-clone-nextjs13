  ...
  return (
    <div className='flex lg:max-w-screen-lg sm:max-w-sm min-w-0 overflow-x-auto overflow-y-hidden snap-x space-x-4 select-none '>
      {favMovies.map(favMovie =>
        <div key={favMovie.id} className='items-center flex flex-col align-middle snap-center border-2 border-solid
                    border-white rounded-lg p-2 space-y-1 cursor-pointer'>
